 ...
 */
function esn-satellite_profile_modules() {
 ...
 */
function esn-satellite_profile_details() {
  return array(
    'name' => 'ESN Satellite',
    'description' => 'Select this profile to install ESN Satellite.'
  );
}
 ...
 *   screen.
 */
function esn-satellite_profile_final() {
